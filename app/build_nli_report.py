...
TABS = [
    dict(
        ...
        ask='לתקן את ערכי 034 לפי העמודה "הערך המתוקן". זה תיקון מכני: '
            'הערך הנכון נגזר מן הערך הקיים בהוספת האפס החסר, ואינו מצריך '
            'החלטה של מחלקת הקטלוג באף אחד מן המקרים.',
    ...
    dict(
        ...
        tasks={'A10', 'A13'},
        title='שתי רשומות לאותו מקום',
        short='כפילות ברשומות',
        kind='judgment',
        why='שתי רשומות זהות־מקום נפרדות ב־NLI מתארות מקום אחד. בחלק מן המקרים העדות '
    ...
    dict(
        ...
        kind='judgment',
        why='שתי רשומות זהות־מקום נפרדות — שני מקומות ממשיים ושונים — נושאות בדיוק את '
            ...
            'Lüben ו־Lübben שניהם "לובן (גרמניה)".',
...
def write_xlsx(payload, path):
    ...
    intro['A1'] = 'דוח שגיאות ברשומות זהות של מקומות — אוסף כימה'
    intro['A1'].font = Font(bold=True, size=14)
    lines = [
        '',
        'עודכן לאחרונה: %s' % payload['generated'],
