...
TASKS = {
  ...
  'B4': dict(mech=True, group='ב', title='034 — אפס מוביל שנשמט', buttons=['keep-existing', 'apply-new', 'research', 'skip'],
  ...
  'B5': dict(mech=True, group='ב', title='תיבה חוצה את קו התאריך', buttons=['runner-bug', 'keep-existing', 'skip'],
  ...
  'B7': dict(mech=True, group='ב', title='קואורדינטות כימה שגויות', buttons=['apply-new', 'keep-existing', 'research', 'skip'],
  ...
  'B12': dict(mech=True, group='ב', title='גאומטריה פגומה', buttons=['data-problem', 'manual-coords', 'keep-existing', 'skip'],
  ...
  'C1': dict(mech=True, group='ג', title='"לא קיים ב־NLI" — פער כיסוי של IIIF', buttons=['dismiss', 'research', 'skip'],
  ...
  'Z': dict(mech=True, group='', title='הוחלט — לא בדוח הנוכחי', buttons=['research', 'skip'], bulk=None, bulkConf=None,
